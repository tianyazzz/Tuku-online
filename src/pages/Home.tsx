              ...
              <div key={image.id} className="bg-white rounded-lg shadow-sm border border-zinc-200 overflow-hidden group">
                <div className="aspect-square bg-zinc-100 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                    <button 
                      ...
                      className="icon-btn p-2 rounded-full bg-white text-zinc-700 shadow-sm hover:text-blue-500 hover:bg-blue-50"
                      title="复制链接"
                    >
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    <button 
                      onClick={() => copyToClipboard(image.url)}
                      className="text-xs text-blue-500 hover:text-blue-600 flex items-center gap-1 transition duration-150 ease-out transform-gpu active:scale-[0.99]"
                    >
